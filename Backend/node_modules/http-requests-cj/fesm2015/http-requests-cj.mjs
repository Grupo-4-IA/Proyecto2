...
class HttpRequestsCJService {
    ...
    get(url, params, headers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield lastValueFrom(this.http.get(url, { params: param, headers: header }));
        });
    }
    /**
    ...
    post(url, body, params, headers) {
        return __awaiter(this, void 0, void 0, function* () {
            let param = this.makeParams(params);
            let header = this.makeHeaders(headers);
            return yield lastValueFrom(this.http.post(url, body, { params: param, headers: header }));
        });
    }
    /**
    ...
    delete(url, params, headers) {
        return __awaiter(this, void 0, void 0, function* () {
            let param = this.makeParams(params);
            let header = this.makeHeaders(headers);
            return yield lastValueFrom(this.http.delete(url, { params: param, headers: header }));
        });
    }
    /**
    ...
    put(url, body, params, headers) {
        return __awaiter(this, void 0, void 0, function* () {
            let param = this.makeParams(params);
            let header = this.makeHeaders(headers);
            return yield lastValueFrom(this.http.put(url, body, { params: param, headers: header }));
        });
    }
}
